...
export default function Home() {
	return (
		<>
			...
			<main className={inter.className} id='container'>
				<div
					id='body'
					style={{
						width: '100%',
					...
					<div style={{ marginBottom: 58, marginTop: 48 }}>
					...
					<ul style={{ marginBottom: 56 }} className={styles.list}>
					...
					<a
						href='https://github.com/Jared-Dahlke/nextauth-lnurl-template'
						className={styles.description}
						target='_blank'
						rel='noopener noreferrer'>
						<svg
