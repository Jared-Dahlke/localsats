...
const MessageGroup = ({
	...
	return (
		<div className='w-full relative md:max-w-xl max-w-xs shadow-xl rounded-lg flex items-center gap-5 p-4  min-w-0'>
			{messageGroup.hasUnreadMessages && (
				<div className=' absolute top-0 -right-2 flex-none rounded-full bg-green-400/10 p-1 text-green-400'>
					<div className='h-2 w-2 rounded-full bg-current' />
				</div>
			)}

			<div className='flex flex-col gap-2 items-start'>
				<div className='stat-title'>Order Id: {getPostId(post?.id)}</div>
			...
			<div className='content truncate gap-3 flex flex-col'>
				<div>
